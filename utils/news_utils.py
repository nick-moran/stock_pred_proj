...
def get_hourly_news_by_date(date, daily_stock_chart, news_data):
    """
    ...
    open_dates = list(daily_stock_chart['date'])
...
# daily_stock_chart = pd.read_csv('../charts/APPLE1440.csv')
# news_data = pd.read_csv('../datasets/news_data_filtered.csv')
# news_data['time'] = pd.to_datetime(news_data['time'])


# get_hourly_news_by_date('2018-05-07', daily_stock_chart, news_data)
